...
gtag('config', 'G-DPB6FYJYYX');`,
      ...
      <body className={`${specialGothic.variable} ${lexend.variable} antialiased`} suppressHydrationWarning>
        ...
        <a
          href="http://wa.me/+12017048254"
          target="_blank"
          rel="noopener noreferrer"
          aria-label="Contact us on WhatsApp"
          className="fixed bottom-5 right-5 z-50 w-[40px] h-[40px] md:w-[80px] md:h-[80px] flex items-center justify-center rounded-full bg-[#25D366] shadow-lg hover:scale-110 transition-transform"
        >
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="white" className="w-[20px] h-[20px] md:w-[40px] md:h-[40px]">
