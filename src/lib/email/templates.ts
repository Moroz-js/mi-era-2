        ...
        <table role="presentation" style="max-width: 600px; width: 100%; background-color: #ffffff; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
          ...
          <tr>
            <td align="center" style="padding: 40px 20px 20px;">
              <img src="{{logoUrl}}" alt="Mi-Era" width="196" height="52" style="display: block; margin: 0 auto; max-width: 100%; height: auto;" />
            </td>
          </tr>
...
export function getEmailVariables(email: string) {
  const siteUrl = process.env.NEXT_PUBLIC_BASE_URL || 'https://mi-era.org';
